package ru.mirea.lukutin.notificationapp
...
class MainActivity : AppCompatActivity() {
    ...
    val CHANNEL_ID: String = "com.mirea.asd.notification.ANDROID"
    var IDENTIFICATE_MSG: Int = 0
    ...
    fun onClickSendNotification(view: View) {
        ...
        notificationManger.notify(IDENTIFICATE_MSG++,notification)
    }
}