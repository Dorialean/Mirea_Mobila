package ru.mirea.lukutin.yandexdriver;
...
public class MainActivity extends AppCompatActivity implements
    ...
    private final String MAPKIT_API_KEY = "9ac2b06c-9798-463c-ba98-50759976396c";
    ...
    public void onDrivingRoutesError(@NonNull Error error) {
        String errorMessage = getString(com.yandex.runtime.R.string.common_google_play_services_unknown_issue);
